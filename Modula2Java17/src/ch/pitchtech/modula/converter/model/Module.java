...
public class Module extends SourceElement implements ICompilationUnit, IImplemented, IHasScope {
    ...
    public Module(SourceLocation sLoc, String name, Application application) {
        super(sLoc);
        this.name = name;
    ...
    public void setProcedures(List<ProcedureImplementation> procedures) {
    ...
    public IScope getLocalScope() {
        if (myScope == null)
            myScope = new CompilationUnitScope(this, application, null, imports, constantDefinitions, typeDefinitions,
