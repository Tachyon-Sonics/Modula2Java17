...
public class WhileLoop extends SourceElement implements IStatement, IStatementsContainer {
    
    private final IExpression condition;
    private final List<IStatement> statements = new ArrayList<>();
    
    
    public WhileLoop(SourceLocation sLoc, IExpression condition) {
        super(sLoc);
    ...
    public String toString() {
        return "WhileLoop [condition=" + condition + ", statements=" + statements + "]";
    }
